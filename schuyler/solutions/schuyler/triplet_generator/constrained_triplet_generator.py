...
class ConstrainedTripletGenerator(BaseTripletGenerator):
    ...
    def generate_triplets(self):
        ...
        for entity_table in entity_tables:
            ...
            i = 0
            while i < 4 or not negative_candidates:
...
class DatabaseSchemaAnalyzer():
    ...
    def rank_tables(self):
        ...
        df_sorted.to_csv("/data/database_schema_analysis.csv")
    ...
    def get_entity_tables(self):
        ...
        print(table_ranking["sum_of_zscores"])
        ...
        while i < 30:
            ...
            for neighbour in neighbours:
                table_ranking.loc[table_ranking["table_name"] == neighbour.table.table_name, "sum_of_zscores"] -= 0.02
            table_ranking = table_ranking[table_ranking["table_name"] != node.table.table_name]
            table_ranking = table_ranking.sort_values("sum_of_zscores", ascending=False)
            i += 1
        return entities
