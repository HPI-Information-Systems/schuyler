...
class GPTSolution(BaseSolution):
    ...
    def train(self):
        ...
        return None, None
    def test(self, gpt_model,seed, sql_file_path, schema_file_path, groundtruth, model):
        start_time = time.time()
        with open(schema_file_path, 'r') as file:
            sql_content = file.read()

        basic_prompt = f"Here is an SQL script:\n{sql_content}. Please return a clustering of the database tables as an array of arrays. Do not return anything else but a list of lists consisting of only database tables. Do not format your response, don't add any linebreaks or don't add any ``` or similar. Do not format it as json, but return plain text. Make sure that you include all provided tables of the sql file in the clustering."
        ...
        # gt = clusters: ["edit_area", "area_tag_raw","area_tag","area_annotation","l_area_area", "l_area_url", "area_containment", "area_gid_redirect", "area_alias", "area", "area_alias_type", "area_type", "area_attribute", "area_attribute_type", "area_attribute_type_allowed_value", "iso_3166_1", "iso_3166_2", "iso_3166_3"]
        # response = [['edit', 'edit_area', 'edit_artist', 'edit_data', 'edit_event', 'edit_genre', 'edit_instrument', 'edit_label', 'edit_note', 'edit_note_change', 'edit_note_recipient', 'edit_place', 'edit_recording', 'edit_release', 'edit_release_group', 'edit_series', 'edit_url', 'edit_work'], ['artist', 'artist_alias', 'artist_credit', 'artist_credit_gid_redirect', 'artist_credit_name', 'artist_gid_redirect', 'artist_ipi', 'artist_isni', 'artist_meta', 'artist_rating_raw', 'artist_release', 'artist_release_group', 'artist_release_group_nonva', 'artist_release_group_pending_update', 'artist_release_group_va', 'artist_release_nonva', 'artist_release_pending_update', 'artist_release_va', 'artist_tag', 'artist_tag_raw', 'artist_type'], ['area', 'area_alias', 'area_annotation', 'area_attribute', 'area_containment', 'area_gid_redirect', 'area_tag', 'area_tag_raw', 'area_type'], ['event', 'event_alias', 'event_annotation', 'event_attribute', 'event_gid_redirect', 'event_meta', 'event_rating_raw', 'event_series', 'event_tag', 'event_tag_raw', 'event_type'], ['genre', 'genre_alias', 'genre_annotation'], ['instrument', 'instrument_alias', 'instrument_annotation', 'instrument_gid_redirect', 'instrument_tag', 'instrument_tag_raw', 'instrument_type'], ['label', 'label_alias', 'label_annotation', 'label_gid_redirect', 'label_meta', 'label_rating_raw', 'label_tag', 'label_tag_raw', 'label_type'], ['place', 'place_alias', 'place_annotation', 'place_gid_redirect', 'place_meta', 'place_rating_raw', 'place_tag', 'place_tag_raw', 'place_type'], ['recording', 'recording_alias', 'recording_annotation', 'recording_gid_redirect', 'recording_meta', 'recording_rating_raw', 'recording_series', 'recording_tag', 'recording_tag_raw'], ['release', 'release_alias', 'release_annotation', 'release_gid_redirect', 'release_label', 'release_meta', 'release_series', 'release_tag', 'release_tag_raw'], ['release_group', 'release_group_alias', 'release_group_annotation', 'release_group_gid_redirect', 'release_group_meta', 'release_group_rating_raw', 'release_group_series', 'release_group_tag', 'release_group_tag_raw'], ['series', 'series_alias', 'series_annotation', 'series_attribute', 'series_gid_redirect', 'series_tag', 'series_tag_raw'], ['work', 'work_alias', 'work_annotation', 'work_gid_redirect', 'work_meta', 'work_rating_raw', 'work_series', 'work_tag', 'work_tag_raw'], ['country_area', 'deleted_entity', 'editor', 'editor_collection', 'language', 'medium_format', 'release_status', 'script', 'tag', 'url', 'vote']]
        # gt = [
        #         ["edit_area", "area_tag_raw","area_tag","area_annotation","l_area_area", "l_area_url", "area_containment", "area_gid_redirect", "area_alias", "area", "area_alias_type", "area_type", "area_attribute", "area_attribute_type", "area_attribute_type_allowed_value", "iso_3166_1", "iso_3166_2", "iso_3166_3"],
        #         [ "edit_artist", "artist_tag_raw","artist_tag","artist_annotation","l_area_artist", "artist", "l_artist_artist", "l_artist_event", "l_artist_place", "l_artist_url",  "artist_alias", "artist_meta", "artist_release","artist_release_nonva", "artist_release_va", "artist_release_pending_update", "artist_gid_redirect", "artist_ipi", "artist_isni", "artist_type", "gender", "artist_alias_type", "artist_rating_raw", "artist_attribute", "artist_attribute_type", "artist_attribute_type_allowed_value"],
        ...
        #         ["edit_release","release_tag_raw","release_tag","release_annotation", "release","country_area", "l_area_release", "l_artist_release", "l_event_release", "l_place_release", "l_release_release", "l_release_series","release_series", "l_release_url", "release_meta", "release_unknown_country", "release_first_release_date", "release_gid_redirect", "release_alias", "release_country", "release_label", "release_alias_type", "release_status", "release_packaging", "script","release_attribute", "release_attribute_type", "release_attribute_type_allowed_value", "release_event", "alternative_release", "alternative_release_type", "release_raw"],
        ...
        #         ["edit",  "edit_data",     "edit_note", "edit_note_change", "edit_note_recipient",    "vote"],
